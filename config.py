...
SHAIRPORT_LOG_LEVEL = _int("SHAIRPORT_LOG_LEVEL", "0")
...
SHAIRPORT_BUFFER_SECONDS = _get("SHAIRPORT_BUFFER_SECONDS", "0.5")
SHAIRPORT_BUFFER_THRESHOLD_SECONDS = _get("SHAIRPORT_BUFFER_THRESHOLD_SECONDS", "0.25")

ALSA_OUTPUT_DEVICE = _get("ALSA_OUTPUT_DEVICE", _default_alsa_output())
ALSA_MIXER_DEVICE = _get("ALSA_MIXER_DEVICE", "whisplaysound")
ALSA_MIXER_CONTROL = _get("ALSA_MIXER_CONTROL", "speaker")
...
DISPLAY_FPS = _int("DISPLAY_FPS", "5")
